...
from card_game_ai.game.cards import HANABI_COLORS, Card, Color, Rank
from card_game_ai.game.engine import EngineStepResult, HanabiGameEngine
...
def render_player_observation(observation: PlayerObservation) -> str:
    """
...
def render_step_result(step_result: EngineStepResult) -> str:
    """
...
def render_self_play_turn(
    *,
    ...
    lines = [
        ...
        render_player_observation(observation),
        "",
        "Chosen action:",
