...
class ConventionTempoHeuristicAgentTests(SharedHeuristicAgentTests, unittest.TestCase):
    ...
    def test_convention_tempo_agent_uses_five_player_ranking_to_break_raw_score_ties(self) -> None:
        observation = PlayerObservation(
            observing_player=0,
            current_player=0,
            hand_knowledge=(CardKnowledge(
            ...
            other_player_hands=(
                ...
                ObservedHand(player_id=2, cards=(Card(Color.GREEN, Rank.THREE), Card(Color.GREEN, Rank.FOUR))),
                ObservedHand(player_id=3, cards=(Card(Color.YELLOW, Rank.TWO),)),
                ObservedHand(player_id=4, cards=(Card(Color.WHITE, Rank.ONE),)),
            ),
            fireworks={color: 0 for color in Color},
            discard_pile=(),
        ...
        rich_but_local_hint = agent._hint_priority(
            observation,
            observation.other_player_hands[1],
        ...
        self.assertGreater(far_coordination_hint, rich_but_local_hint)
