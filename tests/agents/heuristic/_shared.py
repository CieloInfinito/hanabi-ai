...
class SharedBasicHeuristicVariantTests(ABC):
    def test_basic_heuristic_agent_can_choose_plain_rank_hint_action(self) -> None:
        # Verifies that the baseline non-convention heuristic can choose a
        # rank hint when that more directly creates a safe play, and still
        # returns a plain action.
    ...
    def test_basic_heuristic_agent_returns_plain_rank_hint_without_private_presentation(self) -> None:
        # Verifies that the baseline non-convention heuristic emits rank hints
        # as plain actions instead of grouping hinted cards by playability.
    ...
    def test_basic_heuristic_agent_does_not_apply_color_hint_private_inference(self) -> None:
        # Verifies that the baseline non-convention heuristic ignores the
